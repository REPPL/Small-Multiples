...
This **arrangement of charts** allows us to present **a lot of
...
As a result, this visualisation **creates awareness**, which in itself
...
describes as
    ...
    mak[ing] some things on a data graphic easier to see or find than others.
